...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "🔰 **Klik For Deploy:** [┣─[ 𝐁𝐨𝐭 𝐕𝐢𝐫𝐮𝐬 ]─┫](https://heroku.com/deploy?template=https://github.com/tungauicipiyey/Kampang-Bot/tree/Kampang)"\n╰►Pemilik  :  [TUNGAU](https://t.me/DamnBitchh)"
    )
